...
Below are notes taken when implementing the GraphQL starter.
...
Create /typeDefs/index.js.  Note, the approach here uses 'schema stitching' so that we can abstract user and sale queries, mutations, subscriptions together.
